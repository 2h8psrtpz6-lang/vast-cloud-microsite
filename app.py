...
# ── Page state ────────────────────────────────────────────────────────────────
if "show_ncp" not in st.session_state:
...
<div class="hero">
  ...
  <div class="hero-ctas">
    ...
    <a href="#ncp-section" class="btn-secondary">Why NCPs Choose VAST →</a>
...
# ── NCP Page ──────────────────────────────────────────────────────────────────
st.markdown('<div id="ncp-section"></div>', unsafe_allow_html=True)
st.markdown("<hr style='border:1px solid #1a2540;margin:48px 0;'>", unsafe_allow_html=True)
