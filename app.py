...
if current_page == "ncp":
    st.markdown("""
    <style>
    .back-btn { display:inline-block;padding:10px 20px;background:rgba(0,120,255,0.12);border:1px solid rgba(0,194,224,0.4);border-radius:8px;color:#00c2e0;font-size:13px;font-weight:600;text-decoration:none;margin-bottom:32px; }
    </style>
    """, unsafe_allow_html=True)
    if st.button("← Back to VAST AI Factory", type="secondary"):
...
<div class="hero">
  ...
  <div class="hero-ctas">
    ...
    <a href="?page=ncp" class="btn-secondary" target="_self">Why NCPs Choose VAST →</a>
